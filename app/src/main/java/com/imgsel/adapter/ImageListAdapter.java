...
public class ImageListAdapter extends EasyRVAdapter<Image> {
    ...
    private OnItemClickListenerCommon listener;
    ...
    protected void onBindData(final EasyRVHolder viewHolder, final int position, final Image item) {
        ...
        if (position == 0 && showCamera) {
            ...
            iv.setImageResource(R.drawable.ic_post_camera);
                    ...
                    if (listener != null) {
                        ...
                        if (ret == 1) { // 局部刷新
                            if (Constant.imageList.contains(item.path)) {
                                viewHolder.setImageResource(R.id.ivPhotoCheaked, R.drawable.ic_select_p);
                            } else {
                                viewHolder.setImageResource(R.id.ivPhotoCheaked, R.drawable.ic_select_n);
                            }
                        }
                    }
                }
    ...
    public void setOnItemClickListener(OnItemClickListenerCommon listener) {
