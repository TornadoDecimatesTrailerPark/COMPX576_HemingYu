...
public class Logon extends BaseActivity {
    @BindView(R.id.logon_user_name)
    TextView userName;
    @BindView(R.id.logon_user_pass)
    TextView userPass;
    @BindView(R.id.logon_user_pass_aga)
    TextView userPassAga;
    @BindView(R.id.logon_user_email)
    TextView userEmail;
    @BindView(R.id.logon_login)
    TextView logon_login;
