...
public class HomeFragment_8 extends Fragment implements MyRecyclerViewAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view==null){
            view = inflater.inflate(R.layout.home_viewp_itemv8,container,false);
            initView(view);
        }else {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.homeFragment8);
        swiperefreshlayout = view.findViewById(R.id.swiperefreshlayout8);
