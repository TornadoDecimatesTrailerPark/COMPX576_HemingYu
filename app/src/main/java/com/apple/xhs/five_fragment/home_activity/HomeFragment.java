...
import com.apple.xhs.five_fragment.home_activity.home_fragment.HomeFragment_12;
import com.apple.xhs.five_fragment.home_activity.home_fragment.HomeFragment_3;
import com.apple.xhs.five_fragment.home_activity.home_fragment.HomeFragment_4;
import com.apple.xhs.five_fragment.home_activity.home_fragment.HomeFragment_5;
import com.apple.xhs.five_fragment.home_activity.home_fragment.HomeFragment_6;
...
public class HomeFragment extends Fragment implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void addAllFragment() {
        adapter.addFragment(homeFragment_1,"AA");
        adapter.addFragment(homeFragment_3,"CC");
        adapter.addFragment(homeFragment_4,"DD");
        adapter.addFragment(homeFragment_5,"EE");
        adapter.addFragment(homeFragment_6,"FF");
        adapter.addFragment(homeFragment_7,"GG");
        adapter.addFragment(homeFragment_8,"HH");
        adapter.addFragment(homeFragment_9,"II");
        adapter.addFragment(homeFragment_10,"JJ");
        adapter.addFragment(homeFragment_11,"KK");
        adapter.addFragment(homeFragment_12,"LL");
    }
