...
public class HomeFragment_6 extends Fragment implements MyRecyclerViewAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view==null){
            view = inflater.inflate(R.layout.home_viewp_itemv6,container,false);
            initView(view);
        }else {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.homeFragment6);
        swiperefreshlayout = view.findViewById(R.id.swiperefreshlayout6);
